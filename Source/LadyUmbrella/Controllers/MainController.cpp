...
AMainController::AMainController()
{
	...
	FWidgetAssets::SelectorElementTemplate = AssetUtils::FindClass<UInputElement>(TEXT("/Script/UMGEditor.WidgetBlueprint'/Game/Widgets/WidgetBlueprints/Menu/Input/WBP_SelectorInputOption.WBP_SelectorInputOption_C'"));
	FWidgetAssets::SliderElementTemplate = AssetUtils::FindClass<UInputElement>(TEXT("/Script/UMGEditor.WidgetBlueprint'/Game/Widgets/WidgetBlueprints/Menu/Input/WBP_SliderInputOption.WBP_SliderInputOption_C'"));
	FWidgetAssets::ToggleElementTemplate = AssetUtils::FindClass<UInputElement>(TEXT("/Script/UMGEditor.WidgetBlueprint'/Game/Widgets/WidgetBlueprints/Menu/Input/WBP_ToggleInputOption.WBP_ToggleInputOption_C'"));
	FWidgetAssets::SubsectionTitleTemplate = AssetUtils::FindClass<UUserWidget>(TEXT("/Script/UMGEditor.WidgetBlueprint'/Game/Widgets/WidgetBlueprints/Menu/Input/WBP_SubsectionTitle.WBP_SubsectionTitle_C'"));
}
...
ELanguageCode AMainController::GetNextLanguageCode()
{
	if (GetLanguageCode() == ELanguageCode::EN_US) return ELanguageCode::ES_ES;
	if (GetLanguageCode() == ELanguageCode::ES_ES) return ELanguageCode::SV_SE;

	return ELanguageCode::EN_US;
	
	// uint8 Result = StaticCast<uint8>(GetLanguageCode()) + 1 % StaticCast<uint8>(ELanguageCode::OTHER);
	// return StaticCast<ELanguageCode>(Result);
}
...
void AMainController::ClearWidgets() const
{
	if (!IsValid(MainHUD))
	{
		FLogger::ErrorLog("Invalid MainHUD pointer in MainController.ClearWidgets()");
		return;
	}
	
	MainHUD->ClearWidgets();
}
