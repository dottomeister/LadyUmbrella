...
void UMainMenu::NativeConstruct()
{
	...
	GetContinueButton()->SetState(EUIState::Disabled);
	GetChaptersMenuButton()->SetState(EUIState::Disabled);
}
...
void UMainMenu::NativeOnInitialized()
{
	...
	{
		FChaptersProgress var = GameInstance->GetSaveGameFile()->GetChaptersProgress().begin().Value();
		if (var.bChapterUnlocked)
		{
			GetContinueButton()->SetState(EUIState::Idle);
			GetChaptersMenuButton()->SetState(EUIState::Idle);
		}
	}
}
