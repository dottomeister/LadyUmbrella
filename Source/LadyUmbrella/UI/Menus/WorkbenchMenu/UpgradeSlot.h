...
public:
	...
	FORCEINLINE FText& GetDescription() { return UpgradeDescription; }
	...
	FORCEINLINE void SetDescription(const FText& Description) { UpgradeDescription = Description; }
	FORCEINLINE void SetImage(const FText& Description) { UpgradeDescription = Description; }
