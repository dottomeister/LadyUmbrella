...
class LADYUMBRELLA_API UChapterSelectorMenu : public UMenu
{
	...
	UAnimatedMenuButton* ChapterOne;

	UPROPERTY(BlueprintReadWrite, meta = (BindWidget, AllowPrivateAccess = "true"))
	UAnimatedMenuButton* ChapterTwo;

	UPROPERTY(BlueprintReadWrite, meta = (BindWidget, AllowPrivateAccess = "true"))
	UAnimatedMenuButton* ChapterThree;

	UPROPERTY(BlueprintReadWrite, meta = (BindWidget, AllowPrivateAccess = "true"))
	UAnimatedMenuButton* ChapterFour;

	UPROPERTY(BlueprintReadWrite, meta = (BindWidget, AllowPrivateAccess = "true"))
	UAnimatedMenuButton* ChapterFive;
	...
	UPROPERTY()
	TArray<UAnimatedMenuButton*> Chapters;
