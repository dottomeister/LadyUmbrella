...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnSaveButtonClicked, const FString&, SaveSlotNamePressed);
 ...
 */
UCLASS()
class LADYUMBRELLA_API UAnimatedButtonSaveMenu : public UAnimatedBaseButton
{
	GENERATED_BODY()
