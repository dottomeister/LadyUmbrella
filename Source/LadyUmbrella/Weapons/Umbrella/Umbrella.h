...
DECLARE_DELEGATE_FourParams(FOnUmbrellaStateChanged, bool, bool , bool, bool ); /*IsAiming, IsOpen, IsOnEnemy, IsOnElementHookable*/
...
DECLARE_DELEGATE_ThreeParams(FOnUmbrellaRangeAndSpread, float, float, float);
...
DECLARE_DELEGATE_OneParam(FOnShootingCadence, FTimerHandle);
DECLARE_DELEGATE_TwoParams(FOnCanShoot, bool, float);
