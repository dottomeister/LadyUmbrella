...
void APlayerCharacter::BeginPlay()
{
	...
	FGlobalPointers::MainController->TogglePlayerHUD();
	(void) FGlobalPointers::Umbrella->OnUmbrellaRangeAndSpread.ExecuteIfBound(FGlobalPointers::Umbrella->GetBulletRange(), FGlobalPointers::Umbrella->GetSpreadAngleX(), FGlobalPointers::Umbrella->GetSpreadAngleZ());
...
void APlayerCharacter::Shoot() const
{
	...
	if (FGlobalPointers::Umbrella->TryToShoot())
	{
		...
		Steam::UnlockAchievement(ESteamAchievement::TEST_ACHIEVEMENT);
	}
}
